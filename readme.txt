...
This app can use the station "ID", found on the "My Devices", and "Your API key", found on the "API KEYS" tab, of your weather station to grab the data from Weather Underground once every minute. The web site limits requests to 10 per minutes and 1500 per day so I have chosen 1 minutes intervals so it can run all day.
